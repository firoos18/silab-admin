...
class _$ClassesInSubjectEntityImpl implements _ClassesInSubjectEntity {
  const _$ClassesInSubjectEntityImpl(
      {this.id,
      this.subject,
      this.name,
      this.quota,
  ...
  @override
  String toString() {
    return 'ClassesInSubjectEntity(id: $id, subject: $subject, name: $name, quota: $quota, isFull: $isFull, day: $day, startAt: $startAt, endAt: $endAt, participants: $participants, learningModule: $learningModule)';
  }
...
abstract class _ClassesInSubjectEntity implements ClassesInSubjectEntity {
  const factory _ClassesInSubjectEntity(
      ...
      final String? endAt,
      final List<String>? participants,
      final List<String>? learningModule}) = _$ClassesInSubjectEntityImpl;
